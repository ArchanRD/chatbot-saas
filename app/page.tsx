...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen font-inter  ${isDarkMode ? "dark" : ""}`}>
      <div className="relative min-h-screen overflow-hidden transition-colors duration-300 before:absolute before:inset-0 before:bg-[radial-gradient(circle,_rgba(10,10,30,1)_0%,_rgba(0,0,10,1)_100%)] before:z-[-1]">
        <div className="max-w-7xl mx-auto">
          ...
          <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4 text-center">
            ...
            <motion.p
              ...
              className="text-gray-400 text-xl md:text-2xl max-w-2xl bg-gradient-to-t from-[#98c0ef] to-[#98c0ef] text-transparent bg-clip-text"
            >
